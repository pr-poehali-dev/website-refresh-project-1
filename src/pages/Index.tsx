          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              {[
                {
                  icon: "BadgeCheck",
                  title: "Оцениваем реальный опыт кандидата",
                  text: "Проводим глубинные интервью, тестовые задания и проверку фактов. Вы встречаетесь с кандидатами, чей опыт подтверждён делами, а не нейросетью.",
                },
                {
                  icon: "Search",
                  title: "Привлекаем лучших через «упаковку» вакансии",
                  text: "Используем маркетинговые инструменты и прямой поиск, чтобы выходить на пассивных кандидатов. Умеем так презентовать вакансию, что откликаются даже те, кто не планировал менять место.",
                },
                {
                  icon: "BarChart2",
                  title: "Даём актуальную аналитику по зарплатам",
                  text: "Через нас ежемесячно проходят десятки офферов. Знаем реальные вилки, ожидания кандидатов и рыночные условия в Иркутске.",
                },
                {
                  icon: "ClipboardCheck",
                  title: "Находим тех, кто приносит результат",
                  text: "Ориентируемся не на «красивый опыт», а на способность решать ваши бизнес-задачи. Подбираем сотрудников, которые усиливают команду и влияют на прибыль.",
                },
                {
                  icon: "Zap",
                  title: "Не даём потерять финалиста на финише",
                  text: "Держим постоянный контакт с финалистом, первыми узнаём о встречных предложениях и их условиях. Помогаем найти компромисс, чтобы сделка состоялась на выгодных для вас условиях.",
                },
              ].map((item, i) => (
                <div key={i} className="flex items-start gap-4 bg-card border border-border rounded-2xl p-5">
                  <div className="flex-shrink-0 w-9 h-9 rounded-full bg-[#c04000]/10 flex items-center justify-center mt-0.5">
