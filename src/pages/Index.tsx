...
const cases: CaseData[] = [
  ...
  },
  {
    ...
    desc: "Бизнес только формировался: нет офиса, нет бренда, кандидаты сомневались. Нашли специалиста с 15-летним опытом в закупках за 15 дней.",
    result: "1 специалист",
    duration: "15 дней",
    icon: "Package",
    fullContent: {
      ...
      outcome: {
        title: "Результат",
        text: "Позиция закрыта за 15 дней. Кандидат с более чем 15-летним опытом в закупках принял предложение:",
        items: [
