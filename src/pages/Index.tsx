        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <button onClick={() => scrollTo("home")} className="flex items-center gap-1">
            ...
            <svg width="30" height="34" viewBox="0 0 30 34" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="0" y="0" width="30" height="34" rx="1" fill="#ff6b1a"/>
              <rect x="7" y="10" width="16" height="24" rx="1" fill="hsl(30,20%,97%)"/>
              <rect x="0" y="0" width="30" height="10" rx="1" fill="#ff6b1a"/>
              <rect x="0" y="0" width="7" height="34" fill="#ff6b1a"/>
              <rect x="23" y="0" width="7" height="34" fill="#ff6b1a"/>
              <circle cx="20" cy="22" r="1.8" fill="#ff6b1a"/>
            </svg>
