...
const cases: CaseData[] = [
  ...
  },
  {
    id: 6,
    tag: "Ритейл",
    title: "Как наняли категорийного менеджера в супермаркет крепежа с нуля, когда бренда ещё не существовало",
    ...
    fullContent: {
      ...
      funnel: [
        { label: "Представлено кандидатов клиенту", value: "6" },
        { label: "Отказались из-за старта бизнеса", value: "2" },
