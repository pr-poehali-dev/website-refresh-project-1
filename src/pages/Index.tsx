      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col gap-0">
            {[
              { n: "1", title: "Получите чёткий портрет кандидата и рыночную вилку зарплат", desc: "Вместе с вами детально прорабатываем требования к кандидату. Вы получаете актуальный срез зарплат по рынку Иркутска, чтобы точно знать, сколько стоит нужный специалист." },
              { n: "2", title: "Знайте реалистичные сроки закрытия вакансии", desc: "Фиксируем прозрачный план работ с прогнозом по времени. Вы понимаете, когда ждать первых финалистов и когда сотрудник выйдет на работу." },
              { n: "3", title: "Получите внимание сильных кандидатов, даже если ваш бюджет не выше рынка", desc: "Упаковываем вашу вакансию и компанию так, чтобы предложение выделялось. Используем прямой поиск и рекомендации, чтобы достучаться до пассивных кандидатов." },
              { n: "4", title: "Получайте только проверенных финалистов — без потока случайных резюме", desc: "Проводим многоступенчатый отбор: интервью по компетенциям, тестовые задания, проверка рекомендаций. Вы не тратите время на отсев." },
              { n: "5", title: "Встречайтесь с лучшими и выбирайте, опираясь на факты", desc: "К каждому финалисту прилагаем подробное заключение: сильные стороны, зоны роста, проверенные данные. Вы принимаете решение на основе объективной информации, а не интуиции." },
              { n: "6", title: "Предлагайте оффер и спокойно ждите выхода сотрудника", desc: null },
            ].map((step, i) => (
              <FadeCard key={i} delay={i * 0.07} className="group grid md:grid-cols-[100px_1fr] gap-6 items-start py-8 border-b border-border last:border-0">
                ...
                <div className="pt-2">
                  ...
                  {step.desc !== null
                    ...
                    : <p className="font-body text-muted-foreground leading-relaxed">Помогаем сформулировать предложение, фиксируем условия и держим контакт с кандидатом до первого рабочего дня. Если на испытательном сроке что-то не складывается — <strong className="text-neon">бесплатно находим замену</strong>.</p>
                  }
                </div>
              </FadeCard>
            ))}
