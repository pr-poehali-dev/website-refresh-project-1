        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-16">
          <div>
            ...
            <p className="font-body text-lg text-foreground/75 leading-relaxed">
              Сегодня мы совмещаем 18-летнюю экспертизу подбора персонала с современными инструментами маркетинга и продаж.<br /><br />Вакансия — такой же продукт, как и любой другой. Мы умеем её «упаковать» и донести до нужной аудитории. Сделать заметной именно для <span style={{color: '#c04000'}}>Вашего</span> кандидата, который, возможно, не находился в активном поиске работы.
            </p>
          </div>
          <AboutAnimation />
        </div>
