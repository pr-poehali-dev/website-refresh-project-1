...
const cases: CaseData[] = [
  ...
  },
  {
    ...
    desc: "Клиент искал 2 месяца самостоятельно — безрезультатно. Профессиональных кавистов в регионе единицы. Нашли за 21 день через двухсегментную стратегию.",
    result: "1 специалист",
    duration: "21 день",
    icon: "Wine",
    fullContent: {
      ...
      outcome: {
        title: "Результат",
        text: "Позиция закрыта за 21 день. Новый сотрудник — мужчина, 31 год. Опыт управления в ресторанном бизнесе, бармен в прошлом:",
        items: [
