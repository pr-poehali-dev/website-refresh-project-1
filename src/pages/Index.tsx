...
const cases: CaseData[] = [
  ...
  },
  {
    id: 10,
    tag: "Строительство",
    title: "Искал медь, а нашёл золото",
    ...
    fullContent: {
      ...
      funnel: [
        { label: "Перестройка фокуса поиска на руководителя", value: "↑" },
        { label: "Холодный контакт с кандидатом вне активного поиска", value: "✓" },
        { label: "Лет опыта в продажах у финального кандидата", value: "20+" },
        { label: "Лет на руководящих позициях", value: "10+" },
        { label: "Недели от старта до оффера", value: "3" },
      ],
      challenges: {
      ...
      outcome: {
        ...
        items: [
          "с мая 2024 года функция подбора персонала в Улан-Удэ полностью под его контролем",
          "команда продолжает формироваться уже под его руководством",
        ],
      },
      conclusion: {
        title: "Вывод",
