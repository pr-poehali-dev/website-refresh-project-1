...
const cases: CaseData[] = [
  ...
  },
  {
    ...
    desc: "Рынок перегрет, хорошие продавцы не ищут работу активно. Нашли двух специалистов уровня бренда через точечный хантинг за 18 дней.",
    ...
    fullContent: {
      ...
      outcome: {
        title: "Результат",
        text: "За 18 дней закрыты 2 позиции. Оба кандидата:",
        items: [
