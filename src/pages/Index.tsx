        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col gap-0">
            {[
              ...
              { n: "6", title: "Предлагайте оффер и спокойно ждите выхода сотрудника", desc: "Помогаем сформулировать предложение, фиксируем условия и держим контакт с кандидатом до первого рабочего дня. Если на испытательном сроке что-то не складывается — бесплатно находим замену." },
            ].map((step, i) => (
