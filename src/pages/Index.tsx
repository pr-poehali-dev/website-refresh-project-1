...
const cases: CaseData[] = [
  ...
  },
  {
    ...
    title: "Как нашли регионального директора по мерчендайзингу в федеральную розничную сеть за 6 дней, когда рынок завален откликами, но нужного кандидата нет",
    ...
    fullContent: {
      ...
      challenges: {
        title: "Основные сложности",
        items: [
          "масса нерелевантных откликов — шум, который не приближал к результату",
      ...
      outcome: {
        title: "Результат",
        text: "Позиция закрыта за 6 дней с первого представленного кандидата. Сотрудница управляла сетью магазинов одежды в федеральной компании и прекрасно понимала тонкости мерчендайзинга. Её кандидатура была первой из трёх представленных заказчику — именно ей было сделано предложение. Переговоры продлились 2 месяца и привели обе стороны к взаимовыгодному успеху.",
        items: [
  ...
  },
  {
    id: 12,
    tag: "Бухгалтерия",
    title: "Нашли бухгалтера в строительную компанию, когда некому передавать дела, а руководители за 5000 км",
  ...
  },
  {
    id: 14,
    tag: "Производство",
    title: "Как нашли менеджера по работе с клиентами в производственную компанию за 17 дней, когда зарплата ниже рынка, а задач — на троих",
  ...
  },
  {
    id: 15,
    tag: "Торговля",
    title: "Как нашли главного бухгалтера в крупную торговую компанию за 12 дней на частичную занятость",
  ...
  },
  {
    id: 16,
    tag: "ЖКХ",
    title: "Как нашли генерального директора в федеральный проект «Оператор ЖКХ» за 23 дня в условиях полной конфиденциальности",
