      ...
      <section id="services" className="py-24 max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="font-body text-lg text-foreground/75 leading-relaxed">
            Сегодня мы совмещаем 18-летнюю экспертизу подбора персонала с современными инструментами маркетинга и продаж. Вакансия — такой же продукт, как и любой другой. Мы умеем её «упаковать» и донести до нужной аудитории. Сделать заметной именно для «Вашего» кандидата, который, возможно, не находился в активном поиске работы.
          </p>
        </div>
